    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.figma.FigmaTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class FigmaTask extends Task implements RunnableTask<FigmaTask.Output> {
    @Schema(
    ...
    @Override
    public FigmaTask.Output run(RunContext runContext) throws Exception {
